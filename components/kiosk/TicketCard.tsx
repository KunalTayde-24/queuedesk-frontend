...
export function TicketCard({ token, ahead }: { token: Token; ahead: number }) {
  return (
    <div
      key={token.id}
      className="relative w-full max-w-[260px] animate-popIn overflow-hidden rounded-card bg-[linear-gradient(160deg,#4E36AD,#3A2A82)] p-7 text-center text-white shadow-lg"
    >
