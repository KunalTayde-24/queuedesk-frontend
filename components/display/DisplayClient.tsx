  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="flex justify-center px-5 pb-16 pt-4">
        <div className="relative w-full max-w-[560px] overflow-hidden rounded-card bg-[linear-gradient(165deg,theme(colors.violet.dark),#3A2A82_60%,#2E1F6B)] px-8 py-12 text-center shadow-lg">
